...
extension FavoriteMusicItemDataModel{
    static let sampleData : [FavoriteMusicItemDataModel] = [
        FavoriteMusicItemDataModel(imageName: "dummy1", title: "POP 갬성 폭발 분위기 끝...", hashTag: "#분위기 #팝송"),
        FavoriteMusicItemDataModel(imageName: "dummy2", title: "청춘드라마 주인공처럼", hashTag: "#기분전환 #기분좋아지기")]
